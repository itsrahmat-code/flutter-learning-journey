...
public class Invoice {
    ...
    // Assuming Product is used as the line item entity (snapshot)
    // CRITICAL: Cascade ALL might be necessary for the bidirectional mapping if you
    // were saving here, but we will manage the save in the service.
